...
# Second binary classification problem to discriminate Alzheimer Disease vs. Mild Cognitive Impairment
...
write.csv(test_preds, file = "0075715_Amin_ADMCIres.csv", row.names = FALSE)
write.csv(features, file = "0075715_Amin_ADMCIfeat.csv", row.names = FALSE)

# Save predictions 
save(test_preds,  file = "0075715_Amin_ADMCIres.RData")
# Save feature indices 
save(features,  file = "0075715_Amin_ADMCIfeat.RData")
